...
from tools.text import remove_strong, remove_br, remove_li, remove_ul, remove_spec_chars, \
...
def read_opp():
    sanitized = files("datasets/OPP-115/sanitized_policies", r"(\d+)_.*")
    annotations = files("datasets/OPP-115/consolidation/threshold-0.75-overlap"
                        "-similarity", r"(\d+)_.*")
